...
export function PodActions({ cluster, namespace, name, kind, replicas }: PodActionsProps) {
  ...
  return (
    <div style={{ display: 'flex', gap: 6 }}>
      ...
      <Modal isOpen={showConfirm} onClose={() => setShowConfirm(false)} title="Restart Pod" width={380}>
      ...
      <Modal isOpen={showScale} onClose={() => setShowScale(false)} title="Scale Deployment" width={380}>
