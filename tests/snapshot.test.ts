...
function makeDetail(overrides: Partial<ResourceDetail> = {}): ResourceDetail {
  return {
    resource: {
      uid: '1', name: 'payment-svc-abc', namespace: 'payments', kind: 'Pod',
      cluster: 'cluster-prod-us', status: 'CrashLoopBackOff', health: 'critical',
      restarts: 14, age: '2h', node: 'node-03', labels: {},
      ownerKind: 'Deployment', ownerName: 'payment-svc'
    },
    events: [
      { timestamp: '14:02', type: 'Normal', reason: 'Created', message: 'Created container', involvedObject: 'pod/payment-svc-abc', count: 1, source: 'kubelet' },
      { timestamp: '14:05', type: 'Warning', reason: 'BackOff', message: 'Back-off restarting', involvedObject: 'pod/payment-svc-abc', count: 3, source: 'kubelet' }
    ],
